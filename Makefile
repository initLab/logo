...
all: $(LOGO_PIXEL_MAP) $(LOGO_PNG_INDEXED) $(LOGO_SVG_RECT) $(LOGO_SVG_PATH)

debug: $(LOGO_ORIGINAL_DEBUG) all

clean:
	rm $(LOGO_ORIGINAL_DEBUG) $(LOGO_JSON) $(LOGO_PIXEL_MAP) $(LOGO_PNG_INDEXED) $(LOGO_SVG_RECT) $(LOGO_SVG_PATH)
